...
function Navbar() {
    ...
    const listItems = [
        { id: 1, text: "Trang chủ", IconText: HomeIcon, linkTo: `/dashboard`, roles: ['ROLE_ADMIN', 'ROLE_TM'] },
        { id: 2, text: "Đào tạo", IconText: Book, linkTo: `/training`, roles: ['ROLE_TM', 'ROLE_ADMIN'] },
        {
            id: 3, text: "Tuyển dụng", IconText: BusinessCenterIcon, roles: ['ROLE_ADMIN', 'ROLE_TM'], children: [
                {
                    id: 1,
                    name: "Nhu cầu",
