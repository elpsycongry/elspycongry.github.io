...
export default function DialogRecruitmentPlanFormCreate({userRoles}) {
                    ...
                    await axios
                        ...
                        .then((res) => {
                            swal("Thêm kế hoạch tuyển dụng thành công", {
                                ...
                                sendNotifications(
                                    null,
                                    `Nhu cầu nhân sự <b>${formData.values.recruitmentPlan.recruitmentRequest.name}</b> vừa cập nhật trạng thái: <b>Đã xác nhận</b>`,
                                    ['ROLE_DM'],
                                    null,
    ...
    return (
        <>
            {hasRoleAdmin() && (
                <div
                    className=" min-width position-relative"
                    style={{width: "280px"}}
                    onClick={handleClickFormOpen}
                >
                    <button
                        className="hover-btn btn-create w-100  text-right clr-white font-w-1 non-outline cursor-pointer">
                    ...
                    <form className="row g-3" onSubmit={formData.handleSubmit}>
                        ...
                        <div className="col-md-12">
                            ...
                            >
                                ...
                                {recuitments
                                    .filter((item) => item.status === "Đã gửi")
                                    .map((item) => (
                        ...
                        <div className="col-md-12 mt-2 ">
                            <p
                                className="grey-text plusTech mb-0 w-160 cursor-pointer"
                                onClick={addTech}
                            >
                                Thêm công nghệ +
                            </p>
                        ...
                        <div className="col-md-8 text-center mt-0">
                            {dateErr && (
                                <p className="err-valid ws-nowrap ">
                                    Thời hạn bàn giao phải lớn hơn thời hạn tuyển dụng tối thiểu
                                    75 ngày
                                </p>
                            )}
                        </div>
