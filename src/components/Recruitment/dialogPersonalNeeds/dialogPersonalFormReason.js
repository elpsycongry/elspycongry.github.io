        ...
        try {
            await axios.post(
                ...
                swal("Cập nhật lý do thành công", {
                    ...
                    sendNotifications(null,`Nhu cầu nhân sự <b>${nameNeedPlan}</b> bị từ chối bởi <b>Quản lý đào tạo</b>`,['ROLE_DM'],null,`/recruitment/personalNeeds?idRequest=${data.values.recruitmentRequest.id}`)
